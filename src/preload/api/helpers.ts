...
export const checkTodayTrackedReleases = makeHandlerInvoker('checkTodayTrackedReleases')
export const detectGameVersion = makeHandlerInvoker('detectGameVersion')
export const resolveDateVersionOnline = makeHandlerInvoker('resolveDateVersionOnline')
export const setGameVersion = makeHandlerInvoker('setGameVersion')
